#
#  Be sure to run `pod spec lint AFXMLDictionarySerializer.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.authors      = { "thiagoperes" => "thiago@appkraft.net", "other author" => "email@address.com" }
  # s.author       = 'thiagoperes', 'other author'
  ...
  s.source       = { :git => "git@github.com:ideaismobile/AFXMLDictionarySerializer.git", :tag => "0.0.1" }
